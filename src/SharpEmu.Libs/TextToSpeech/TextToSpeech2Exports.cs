...
/// <summary>
/// Minimal lifecycle-compatible implementation of the PS5 text-to-speech
/// service. Speech is accepted synchronously until a host speech backend is
/// available, so guests never remain stuck waiting for an unavailable device.
/// </summary>
