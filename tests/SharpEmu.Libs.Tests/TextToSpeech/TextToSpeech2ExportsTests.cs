...
public sealed class TextToSpeech2ExportsTests : IDisposable
{
    ...
    [Fact]
    public void OpenRejectsNullAndUnreadableConfigurationPointers()
    {
    ...
    [Fact]
    public void SpeakAcceptsReadableTextAndCompletesSynchronously()
    {
        InitializeAndOpen();
    ...
    [Fact]
    public void PublicNidsRegisterAsTextToSpeech2Exports()
    {
